...
function parseQmakeProjectFile(proFileName) {
    var parserOutput = { result: false, builtinVariables: undefined, userVars: undefined };
    try {
        ...
        parserOutput = { result: true, builtinVariables: parserOutputObj.builtinVariables, userVars: parserOutputObj.userVars };
    } catch (err) {
...
describe("qmake built-in variables test", function() {
    ...
    describe("TEMPLATE", function() {
        it('valid TEMPLATE=app assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("app", parserOutput.builtinVariables["TEMPLATE"].value);
        });
        it('valid TEMPLATE=lib assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("lib", parserOutput.builtinVariables["TEMPLATE"].value);
        });
        it('valid TEMPLATE=aux assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("aux", parserOutput.builtinVariables["TEMPLATE"].value);
        });
        it('valid TEMPLATE=subdirs assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("subdirs", parserOutput.builtinVariables["TEMPLATE"].value);
        });
        it('valid TEMPLATE=vcsubdirs assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("vcsubdirs", parserOutput.builtinVariables["TEMPLATE"].value);
        });
        it('valid TEMPLATE=vcapp assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("vcapp", parserOutput.builtinVariables["TEMPLATE"].value);
        });
        it('valid TEMPLATE=vclib assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("vclib", parserOutput.builtinVariables["TEMPLATE"].value);
        });
    ...
    describe("CONFIG", function() {
        ...
        it('valid CONFIG=release assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("release", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=debug assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("debug", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=debug_and_release assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("debug_and_release", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=build_all assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("build_all", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=autogen_precompile_source assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("autogen_precompile_source", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=ordered assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("ordered", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=precompile_header assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("precompile_header", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=warn_on assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("warn_on", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=warn_off assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("warn_off", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=exceptions assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("exceptions", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=exceptions_off assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("exceptions_off", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=rtti assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("rtti", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=rtti_off assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("rtti_off", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=stl assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("stl", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=stl_off assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("stl_off", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=thread assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("thread", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=c++11 assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("c++11", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=c++14 assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("c++14", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=create_prl assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("create_prl", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=link_prl assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("link_prl", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=qt assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("qt", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=x11 assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("x11", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=testcase assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("testcase", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=insignificant_test assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("insignificant_test", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=windows assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("windows", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=console assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("console", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=shared assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("shared", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=dll assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("dll", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=static assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("static", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=staticlib assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("staticlib", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=plugin assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("plugin", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=designer assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("designer", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=no_lflags_merge assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("no_lflags_merge", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=flat assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("flat", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=embed_manifest_dll assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("embed_manifest_dll", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=embed_manifest_exe assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("embed_manifest_exe", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=app_bundle assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("app_bundle", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=lib_bundle assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("lib_bundle", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=largefile assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("largefile", parserOutput.builtinVariables["CONFIG"].value);
        });
        it('valid CONFIG=separate_debug_info assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("separate_debug_info", parserOutput.builtinVariables["CONFIG"].value);
        });
        ...
        it('valid CONFIG+=release debug ... separate_debug_info assignment statement', function() {
            ...
            assert.sameMembers([
                ...
                // Windows-specific
                "windows", /*"win32", "msvc", "no_plugin_manifest", */
                //
                 "import_qpa_plugin", "qmake_use",
                /*"incremental_off",*/ "incremental", "file_copies", /*"copy_dir_files",*/ "lex", "yacc",
                "depend_includepath", "testcase_targets", "import_plugins",
                "qml_debug", "release", "debug", "debug_and_release", "debug_and_release_target",
                "build_all", "autogen_precompile_source", "ordered", "precompile_header",
                "warn_on", "warn_off", "exceptions", "exceptions_off", "rtti", "rtti_off", "stl", "stl_off", "thread",
                "c++11", "c++14",
                "create_prl", "link_prl",
                "qt", "testcase", "insignificant_test",
                "console", "shared", "dll", "static", "staticlib", "plugin", "designer", "no_lflags_merge",
                "flat", "embed_manifest_dll", "embed_manifest_exe",
                "app_bundle", "lib_bundle",
                "largefile" ],
                parserOutput.builtinVariables["CONFIG"].value);
        });
    ...
    describe("QT", function() {
        ...
        it('valid QT=core assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("core", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=gui assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("gui", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=widgets assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("widgets", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=network assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("network", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=multimedia assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("multimedia", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=sql assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("sql", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=testlib assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("testlib", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=multimediawidgets assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("multimediawidgets", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=qml assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("qml", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=quick assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("quick", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=axcontainer assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("axcontainer", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=axserver assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("axserver", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=3dcore assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("3dcore", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=3drender assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("3drender", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=3dinput assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("3dinput", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=3dlogic assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("3dlogic", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=3dextras assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("3dextras", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=enginio assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("enginio", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=androidextras assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("androidextras", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=bluetooth assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("bluetooth", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=concurrent assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("concurrent", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=dbus assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("dbus", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=location assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("location", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=macextras assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("macextras", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=nfc assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("nfc", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=opengl assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("opengl", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=positioning assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("positioning", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=printsupport assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("printsupport", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=purchasing assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("purchasing", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=quickcontrols2 assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("quickcontrols2", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=quickwidgets assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("quickwidgets", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=script assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("script", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=scripttools assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("scripttools", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=scxml assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("scxml", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=sensors assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("sensors", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=serialbus assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("serialbus", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=serialport assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("serialport", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=svg assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("svg", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=webchannel assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("webchannel", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=webengine assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("webengine", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=websockets assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("websockets", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=webview assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("webview", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=winextras assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("winextras", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=x11extras assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("x11extras", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=xml assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("xml", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=xmlpatterns assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("xmlpatterns", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=charts assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("charts", parserOutput.builtinVariables["QT"].value);
        });
        it('valid QT=datavisualization assignment statement', function() {
            ...
            assert.equal(true,  parserOutput.result);
            assert.equal("datavisualization", parserOutput.builtinVariables["QT"].value);
        });
        ...
        it('valid QT+=core gui ... datavisualization assignment statement', function() {
            ...
            assert.sameMembers([
                ...
                "sensors", "serialbus", "serialport", "svg", "webchannel", "webengine", "websockets", "webview",
                "winextras", "x11extras", "xml", "xmlpatterns", "charts", "datavisualization"],
                parserOutput.builtinVariables["QT"].value);
        });
    });
    ...
    describe("HEADERS", function() {
        ...
        it('valid HEADERS=... single-line assignment statement', function() {
            ...
            assert.sameMembers([
                ...
                parserOutput.builtinVariables["HEADERS"].value);
        });
    ...
    it('valid SOURCES=... single-line assignment statement', function() {
        ...
        assert.sameMembers([
            ...
            parserOutput.builtinVariables["SOURCES"].value);
    });
